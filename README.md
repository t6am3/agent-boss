...
- 当前 CLI 已支持 `assets`、`mission create/status/report/event/decide/complete`、`judge` 的最小闭环。
...
1. 为 AssetLedger / MissionStore / Supervisor / Reporter 补更细的单元测试。
3. 设计 `MissionRunner` 接口，再按新架构重写 Codex / Claude / OpenClaw adapter。
